                    ...
                    <tbody>
                      ...
                      try {
                        ...
                        foreach ($conn->query($sql) as $row) {
                          echo "<tr><td>" . $row[0] . "</td><td>" . $row[2] . "</td><td>" . $row[3] . "</td><td>" . $row[4] . "</td><td>" . $row[5] . "</td><td><div><a  class='btn bg-gradient-warning btn-xs' href='php/clientesed.php/?proID=" . $row[0] . "''> Editar </a>&nbsp;<a  class='btn bg-gradient-danger btn-xs' href='php/clientesel.php/?proID=" . $row[0] . "'> Eliminar </a> </div></td></tr>";
                        }
                        $conn = null;
