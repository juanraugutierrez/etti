...
<body class="login-page" style="background: url('/dist/img/4.jpg');">
<div class="login-box">
  <div class="login-logo">
    <a href="l"><b>Covid</b>  19</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    ...
    <div class="card-header">
      ...
      <p class="mb-0">
        <a href="php/registrarse.php" class="text-center btn btn-success">Registrarse</a> </p>
    </div>
    <!-- /.login-card-body -->
  </div>
</div>
