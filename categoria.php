...
<head><meta charset="gb18030">
  ...
  <title>Covid-19 | Categorias</title>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Panel de categorias</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="col-lg-12">
              ...
              <div class="card card-danger">
                <div class="card-header">
                  <h3 class="card-title ui-icon-person"> Listado de Categorias</h3>

                  <div class="card-tools">
                    <div><a class="btn btn-success btn-sm" href="acategoria.php">Agregar</a></div>
                    ...
                    <tbody>
                      ...
                      try {
                        ...
                        foreach ($conn->query($sql) as $row) {
                          echo "<tr><td>" . $row[0] . "</td><td>" . $row[1] . "</td><td> <div> <a  class='btn bg-gradient-warning btn-xs' href='#'> Editar </a> <a  class='btn bg-gradient-danger btn-xs' href='php/categoriael.php/?proID=" . $row[0] . "'> Eliminar </a> </div></td></tr>";
                        }
                        $conn = null;
