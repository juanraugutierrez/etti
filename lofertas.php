            ...
            <div class="col-lg-12">
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title ui-icon-person"> Listado de ofertas</h3>

                  <div class="card-tools">
                    <div><a class="btn btn-primary btn-sm" href="aofertas.php">Agregar</a></div>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    try {
                      ...
                      $sql = "SELECT id,nombre,movimiento,producto,cantidad,precio,estado FROM `vista_ofertas`  limit 10";
                      $fila = array();
                      $rows = array();
                      foreach ($conn->query($sql) as $row) {
                        echo "<tr><td>" . $row[0] . "</td><td>" . $row[1] . "</td><td>" . $row[2] . "</td><td>" . $row[3] . "</td><td class='text-right'>" . number_format($row[4], 0, ",", ".") . "</td><td class='text-right'>" . money_format('%#1.0n',$row[5]) . "</td><td>" . $row[6] . "</td><td> <div><a  class='btn bg-gradient-warning btn-xs' href='ofertas.php/?oid=".$row[0]."'>Ver</a>&nbsp;<a class='btn bg-gradient-danger btn-xs' href='php/ofertasel.php/?proID=" . $row[0] . "'> Eliminar </a> </div></td></tr>";
                      }
                      $conn = null;
                ...
                <div class="separador bg-gradient-success1">
                    <!-- <a class="btn-es bg-gradient-success1" href='aofertas.php'>Agregar Oferta</a> -->
                  </div>
