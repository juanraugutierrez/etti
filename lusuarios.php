            ...
            <div class="col-lg-12">
              ...
              <div class="card card-warning">
                <div class="card-header">
                  <h3 class="card-title ui-icon-person"> Listado de Usuarios</h3>

                  <div class="card-tools">
                    <div><a class="btn btn-success btn-sm" href="aclientes.php">Agregar</a></div>
                  ...
                  <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                      ...
                      try {
                        ...
                        $sql = "SELECT id,email,DATE_FORMAT(fecha, '%d/%m/%y') AS fecha FROM usuarios";
                        $fila = array();
                        $rows = array();
                        foreach ($conn->query($sql) as $row) {
                          echo "<tr><td>" . $row[0] . "</td><td>" . $row[1] . "</td><td>" . $row[2] . "</td><td> <div><a  class='btn bg-gradient-warning btn-xs' href='#'> Editar </a>&nbsp;<a  class='btn bg-gradient-danger btn-xs' href='#'> Eliminar </a>&nbsp;<a  class='btn bg-gradient-primary btn-xs' href='#'> Perfil </a> </div></></tr>";
                        }
                        $conn = null;
