      ...
      <div class="content">
        <div class="container-fluid">
          <div class="card card-danger">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="/php/categorian.php" method="post">
              <div class="card-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nombre Categoria</label>
                  <input type="text" name="ncategoria" class="form-control" id="exampleInputEmail1" placeholder="Ingrese Nombre de la Categoria">
                </div>
                <!-- ************* -->
              </div>
              <!-- /.card-body -->
              ...
              <div class="card-footer align-content-end">
                <button type="submit" class="btn btn-success">Agregar</button> <a class="btn btn-primary" href="categoria.php"> Volver </a>
              </div>
            </form>
          </div>
