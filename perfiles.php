          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Panel de Perfiles</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="col-lg-12">
              ...
              <div class="card card-warning">
                <div class="card-header">
                  <h3 class="card-title ui-icon-person"> Listado de Perfiles</h3>

                  <div class="card-tools">
                    <div><a class="btn btn-success btn-sm" href="aperfiles.php">Agregar</a></div>
                  ...
                  <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                      ...
                      try {
                        ...
                        $sql = "SELECT * FROM `tipo_perfiles`";
                        $fila = array();
                        $rows = array();
                        foreach ($conn->query($sql) as $row) {
                          echo "<tr><td>" . $row[0] . "</td><td>" . $row[1] . "</td><td> <div><a  class='btn bg-gradient-warning btn-xs' href='#'> Editar </a>&nbsp;<a  class='btn bg-gradient-danger btn-xs' href='#'> Eliminar </a></div></></tr>";
                        }
                        $conn = null;
