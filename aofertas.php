...
$stmt = $conn->prepare('SELECT nombre from usuarios inner join clientes on usuarios.id_liente=clientes.id where  usuarios.email=?');
$stmt->execute([$email]);
$clientes = $stmt->fetch();
$cliente = $clientes[0];
$cliente = " - " . strtoupper($cliente);

$stmt = $conn->prepare('SELECT id_liente from usuarios where usuarios.email=? limit 1');
$stmt->execute([$email]);
$ids = $stmt->fetch();
$id = $ids[0];
...
<body class="hold-transition sidebar-mini">
            ...
            <div class="col-lg-12">
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title">Agregar Oferta <?= $cliente ?></h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="/php/agroferta.php" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-5">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="lproductos">
                              <?php
                              try {
                                $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                        ...
                        <div class="col-sm-5">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="lmovimiento">
                              <?php
                              try {
                                $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                                $sql = "SELECT descripcion from usuarios_movimientos where email='" . $email . "';";
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="ncantidad" class="form-control numero" id="exampleInputEmail1" placeholder="Ingrese Nombre" style="text-align: right;">
                        </div>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="nprecio" class="form-control numero" id="exampleInputEmail1" placeholder="Ingrese Nombre" style="text-align: right;">
                        </div>
                      </div>

                      <div class="col-sm-3">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Ficha Tecnica </br></label>
                          <input type="file" name="ficha" placeholder="Archivo">
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Foto</br></label>
                          <input type="file" name="foto" id="exampleInputEmail1" placeholder="foto">
                    ...
                    <div class="card-footer separador bg-gradient-success1">
                      <button type="submit" class="btn btn-success"> Agregar </button> <a class="btn btn-primary" href="lofertas.php"> Volver </a>
                    </div>
                </form>
  ...
  <script src="dist/js/pages/botones.js"></script>
</body>
