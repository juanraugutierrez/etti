...
<head><meta charset="gb18030">
  ...
  <title>Covid-19 | Proveedores</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="ofertas.php" class="nav-link">Ofertas Vigentes</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Panel de Proveedores</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <form>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="Nombre" class="form-control" id="exampleInputEmail1" placeholder="Ingrese Nombre">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Direccion</label>
                    <input type="Direccion" class="form-control" id="exampleInputEmail1" placeholder="Ingrese Direccion">
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      <!-- select -->
